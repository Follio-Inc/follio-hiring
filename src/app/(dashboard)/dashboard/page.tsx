  ...
  return (
    <div>
      ...
      <div className="p-8">
        ...
        {/* AI Insight Banner */}
        <div
          className="mb-10 p-6 bg-gradient-to-r from-amber-50/60 via-yellow-50/40 to-orange-50/30 backdrop-blur-xl border border-amber-200/30 rounded-2xl flex items-start gap-4 animate-fade-in-up"
        ...
        <div className="mb-10 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
          <div className="flex items-center justify-between mb-5">
            ...
            <button
              ...
              className="text-sm text-amber-700 hover:text-amber-800 font-semibold flex items-center gap-1 transition-colors"
            >
